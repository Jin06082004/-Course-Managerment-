...
/**
 * Use QuizRepository instead. This interface is deprecated.
 * @deprecated Use QuizRepository
 */
@Repository
@Deprecated
public interface QuizBuilderRepository extends JpaRepository<Quiz, Long> {
